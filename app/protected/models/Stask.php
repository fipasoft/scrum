...
/**
 * This is the model class for table "stask".
 *
 * The followings are the available columns in table 'stask':
 * @property integer $id
 * @property string $key
...
class Stask extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'tasks' => array(self::HAS_MANY, 'Task', 'stask_id'),
		);
	}
   ...
   public static function DropDownListElements(){
        $criteria = new CDbCriteria();
        $criteria->order = "name";
        $items = Stask::model()->findAll($criteria);
        $lista = array();
        $lista[""] = "";
